...
t=0 ^ x=0|...|19 ^ ac=0|...|20 -> 1:x=x+ac'min'20 !guardar
t=0 ^ x=0|...|19 ^ ac=0|...|20 -> 0.166666:ac=ac+1 0.166666:ac=ac+2 0.166666:ac=ac+3 0.166666:ac=ac+4 0.166666:ac=ac+5 0.16667:ac=0,t=1 !lanzar

--Jugador y
--t=1

t=1 ^ y=0|...|19 ^ ac=0|...|20 -> 1:y=y+ac'min'20 !guardar
