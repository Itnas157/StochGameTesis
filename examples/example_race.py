...
t=0 ^ x=0|...|9 -> 0.5: x=min(x+2, 10) | 0.5: x=x;t=1 !!!mov_2
t=0 ^ x=0|...|9 -> 0.5: x=min(x+3, 10) | 0.5: x=max(x-1,0);t=1 !!!mov_3

--Jugador y
--t=1

t=1 ^ y=0|...|9 -> 1: y=y+1;t=0 !!!mov_seguro
t=1 ^ y=0|...|9 -> 0.5: y=min(y + 2, 10) | 0.5: y=y;t=0 !!!mov_2
t=1 ^ y=0|...|9 -> 0.5: y=min(y + 3, 10) | 0.5: y=max(y - 1, 0);t=0 !!!mov_3
"""