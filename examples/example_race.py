...
t=0 ^ x=0|...|9 -> 1:x=x+1 !mov_seguro
t=0 ^ x=0|...|9 -> 0.5:x=x+2 0.5:x=x !mov_2
t=0 ^ x=0|...|9 -> 0.5:x=x+3 0.5:x=x-1max0 !mov_3

--Jugador y
--t=1

t=1 ^ y=0|...|9 -> 1:y=y+1 !mov_seguro
t=1 ^ y=0|...|9 -> 0.5:y=y+2 0.5:y=y !mov_2
t=1 ^ y=0|...|9 -> 0.5:y=y+3 0.5:y=y-1max0 !mov_3
"""